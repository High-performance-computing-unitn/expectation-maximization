...
#PBS -l select=1:ncpus=1:mpiprocs=1 -l place=scatter:excl
...
# # # arguments are                     executable                                  N   D K iter filepath
# # mpiexec -n 80 expectation-maximization/parallel-second-implementation/parallelRun 250000 4 5 200 "expectation-maximization/data-generator/N250000_K5_D4.csv"
