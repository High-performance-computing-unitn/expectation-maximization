...
#PBS -l select=1:ncpus=90:mem=1gb
...
# echo "execution with 128 cores"

# # arguments are                     executable                                    N       D K iter filepath
# mpiexec -n 128 expectation-maximization/parallel-second-implementation/parallelRun 1250000 4 5 200 "expectation-maximization/data-generator/N1250000_K5_D4.csv"
